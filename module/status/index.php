  ...
  if ($pro['status1']=="di Tolak"){
    ...
    $warnastats = "table-warning";
          ...
          <tr>
            ...
            <td><center><a class="dropdown-item" href="module/status/aksi_hapus.php?id=<?php echo $pro['id_lapbul'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
