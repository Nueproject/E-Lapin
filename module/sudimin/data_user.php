...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])) {
  ...
  $datauser= mysqli_query($koneksi,"select * from user where jabatan !='admin' and jabatan !='sudimin' order by nama_pegawai asc");	 	
...
?>
                ...
                <br>               
                  <div class="box-header with-border">
                    ...
                    <a class="dropdown-item" data-toggle="modal" data-target="#tambahAdmin">
                      <button type="button" class="btn btn-sm btn-primary">Tambah User</button></a>
                ...
                <table class="table table-hover table-striped" style="overflow-x: auto!important;">
                  <tbody>
                      ...
                      <tr>             
                        ...
                        <a type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#editUser<?php echo $usr['id'];?>" > 
                         Ubah
                        </a>
                        <a type="button" name="hapusUser" class="btn btn-sm btn-danger" href="module/sudimin/aksi_hapus_user.php?id=<?php echo $usr['id'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')"> 
                         Hapus
                        </a>
                        </td>
  ...
  <div class="modal fade bd-example-modal-lg" id="tambahUser" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
            ...
            <div class="col-md-12">              
              ...
              <div class="form-group">
                ...
                <select class="form-select" aria-label="Default select example" name="jabatan">
                      ...
                      <?php
                      $jabat = mysqli_query($koneksi,"select distinct jabatan from user where jabatan !='admin'");  
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="saveTambahUser" class="btn btn-primary">SIMPAN</button>
      </div>
      </form>
    </div>
  </div>
     ...
     <?php 
      ...
      ?>
  <div class="modal fade bd-example-modal-lg" id="editUser<?php echo $pro['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <center><h3 class="modal-title" id="exampleModalLabel">EDIT USER </h3></center>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="saveEditUser" class="btn btn-primary">SIMPAN</button>
      </div>
      </form>
    </div>
  </div>
