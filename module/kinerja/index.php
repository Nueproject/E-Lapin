...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.8.0/js/bootstrap-datepicker.js"></script>
  ...
  //echo "sekarang bulan ".$bulan;
    ...
    $bulan = getBulan($angka);?>
     ...
     <div class="box-body no-padding">
      ...
      $dataLap = mysqli_query($koneksi,"select id_lap, id_peg, tgl_lap, uraian, output, satuan from data_laporan dl join user u on dl.id_peg = u.id where bulan ='$bln' and tahun ='$tahun' and id_peg ='$user_id' order by tgl_lap desc");  
      $no=0;
  ...
  <?php 
      $dataLaporan = mysqli_query($koneksi,"select * from data_laporan dl join user u on dl.id_peg = u.id where bulan ='$bln' and tahun ='2025' and id_peg ='$user_id'"); 
      while($pro=mysqli_fetch_array($dataLaporan)){ 
       // $tahun = date('Y');
      ?>
