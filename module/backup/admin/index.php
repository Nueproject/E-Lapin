...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])) {
  ...
  $datacuti= mysqli_query($koneksi,"select * from cuti ct join user us on ct.id_peg = us.id where status_cuti = 'Belom ditinjau' and jabatan!='Mutasi' order by mulai_cuti desc");	 	
  $hadir= mysqli_query($koneksi,"select * from absensi ab join user us on ab.id_peg = us.id join shift_kerja sk on ab.id_shift = sk.id_shift join kantor kt on ab.id_kantor = kt.id_kantor where tgl_datang = '$tgl_saiki' and jabatan!='Magang'");	 	
...
body  {
  ...
  background-size: cover;
      ...
      <?php 
      $saiki = date('Y-m-d');
      $dataabs= mysqli_query($koneksi,"select * from absensi ab join user us on ab.id_peg=us.id where tgl_datang='$saiki' and jabatan!='Magang'");	 	
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-xs-6">
                      <div class="small-box bg-aqua">
                        ...
                        <div class="icon">
                          ...
                          <a href="ngadimin.php?module=absen_harian" class="small-box-footer">
                          More info <i class="fa fa-arrow-circle-right"></i>
                          </a>                        
                      </div>
                    </div>
                    <?php 
                    $datact= mysqli_query($koneksi,"select * from cuti ct join user us on ct.id_peg=us.id where mulai_cuti<='$saiki' and selesai_cuti >='$saiki' and jabatan!='Magang'");	 	
                    ...
                    <div class="col-lg-3 col-xs-6">
                      <div class="small-box bg-yellow">
                        ...
                        <a href="ngadimin.php?module=data_cuti" class="small-box-footer">
                        More info <i class="fa fa-arrow-circle-right"></i>
                        </a>
                      </div>
                    </div>
                    <?php
                    $datatel= mysqli_query($koneksi,"select * from absensi ab join user us on ab.id_peg=us.id where tgl_datang='$saiki' and jabatan!='Magang' and status_datang !='Tepat Waktu'");	 	
                    ...
                    <div class="col-lg-3 col-xs-6">
                      <div class="small-box bg-red">
                        ...
                        <a href="ngadimin.php?module=rekap_absensi" class="small-box-footer">
                          More info <i class="fa fa-arrow-circle-right"></i>
                        </a>
                      </div>
                    </div>
                    <?php 
                    $dataiz= mysqli_query($koneksi,"select * from izin iz join user us on iz.id_peg = us.id where mulai_izin<='$saiki' and selesai_izin >='$saiki' and jabatan!='Magang'");	 	
                    ...
                    <div class="small-box bg-green">
                      ...
                      <a href="ngadimin.php?module=data_izin" class="small-box-footer">
                        More Info <i class="fa fa-arrow-circle-right"></i>
                      </a>
                    </div>
                  </div>
                    ...
                    <div class="box box-solid">
                      <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                          <a href="ngadimin.php?module=data_cuti" class="btn btn-sm btn-primary btn-flat">Data Cuti</a>
                        </div>
                      </div>
                          ...
                          <tbody>
                              ...
                              <button type="button" class="btn btn-sm btn-warning dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                      <a href="module/admin/aksi.php?saveAccCuti&id_cuti=<?php echo $cuti['id_cuti']; ?>" type="button" class="btn btn-sm btn-success" role="button" onClick="return confirm('Anda yakin ingin menyetujui cuti ini?')">Di Setujui</a>
                                      <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#tolakCuti<?php echo $idcuti; ?>"><div class="icon-wrapper">TOLAK</button>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="box box-solid">
                      <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                          <a href="ngadimin.php?module=data_laporan" class="btn btn-sm btn-primary btn-flat">Data Laporan</a>
                        </div>
                      </div>
                      <div class="box-body no-padding">
                        <table class="table table-hover table-striped ">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="box box-solid">
              <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                  <a href="ngadimin.php?module=rekap_absensi" class="btn btn-primary btn-flat">Kehadiran</a>
                </div>
              </div>
              <div class="box-body no-padding">
                <table class="table table-hover table-striped ">
  ...
  <?php $datacut= mysqli_query($koneksi,"select * from cuti ct join user us on ct.id_peg = us.id");	 	
  while($pro=mysqli_fetch_array($datacut)){ ?>
        <!-- MODAL TOLAK CUTI -->
         <div class="modal fade bd-example-modal-lg" id="tolakCuti<?php echo $pro['id_cuti'];?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <center><h3 class="modal-title" id="exampleModalLabel">DETAIL CUTI  <b>#<?php echo $pro['nama_pegawai'];?></b></h3></center>
      ...
      <form action="module/admin/aksi.php" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="row">       
            <div class="col-md-12">
              <div class="form-group">
                <table class="table table-striped striped">
                  ...
                  <tr>
                    <td>Alasan</td>
                    <td>:</td>
                    <td><textarea name="alasan_tolak" value="Alasan di Tolak" placeholder="Alasan di Tolak"></textarea></td>
                  </tr>
                 
                </table>
                <input type="hidden" name="id_cuti" value="<?php echo $pro['id_cuti'];?>" placeholder="<?php echo $pro['id_cuti'];?>" />
              </div>             
            </div> <!-- end col-md6 -->        
          </div>  <!-- end row -->      
        </div> <!-- End Modal Body -->
      ...
      <button type="submit" name="saveTolakCuti" class="btn btn-danger">TOLAK CUTI</button>
      </div>
      </form>
    </div>
  </div>
</div> <?php } ?>
        <!-- end modal for TOLAK Cuti -->
