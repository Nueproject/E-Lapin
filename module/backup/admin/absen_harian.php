              ...
              <div class="row box box-solid">
                ...
                <br>
                  ...
                  <div class="col-3" align="right">
                    ...
                    <div class="form-group">
                      <a href="module/admin/download_absensi.php?bulan=<?php echo $bulan;?>&tahun=<?php echo $tahun;?>"><button type="button" class="btn btn-warning btn-md">DOWNLOAD</button></a>                   
                      ...
                      <?php
                       if(isset($_POST['jabatan']) and $_POST['jabatan'] != "*"){
                        ...
                        $jab = "where jabatan ='$jabatan'";
                          ...
                          $jab = "where jabatan !='admin' and jabatan !='Magang' and jabatan !='sudimin' "; 
                        } else {
                          $jab = "where jabatan !='admin' and jabatan !='Magang' and jabatan !='sudimin'"; 
                        }
                    $no=0;
