...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])) {
  ...
  $datacuti= mysqli_query($koneksi,"select * from cuti ct join user us on ct.id_peg = us.id where status_cuti='Di Setujui' and jabatan !='admin' and jabatan !='sudimin' $filteruser $filtertahun order by mulai_cuti desc");	 	
