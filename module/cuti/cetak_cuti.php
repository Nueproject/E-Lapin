...
if ($jumlah>1){
  $waktunya = "$dino_mulai tanggal $tgl_mulai $bulan_mulai $tahun_mulai sampai dengan $dino_selesai $tgl_selesai $bulan_selesai $tahun_selesai";
} else {
...
<body>
  ...
  <br><h4 align="left" width="80%" style="padding-left: 40px;;">Kepada Yth,</h4>
      ...
      <table border="0">
        ...
        <tr>
        <td align="left" style="padding-left: 10px;" width="35%"><p><u>Iwan Setyo Prihatin, SH, M.A.P</u><br>NIP. 197708311997031001</p></td>
          <td></td>
