                ...
                //echo "sekarang bulan ".$bulan;
                  ...
                  <table class="table table-striped">
                    <tr style="background-color: red;">
                      ...
                      <th style="color:white;"><center>Ket</center></th>
                      <th style="color:white;"><center>Aksi</center></th>
                    </tr>
                    <?php
                       $databs= mysqli_query($koneksi,"select * from absensi where id_peg='$user_id' and month(tgl_datang)='$angka' and year(tgl_datang)='$tahun' order by id_absen DESC");	 	
                      ...
                      ?>
                        <tr class="table table-striped">
                         ...
                         <td><center><button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#tambahKet<?php echo $id_abs;?>"><div class="icon-wrapper"><div class="icon-wrapper">
