			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li>
							<a class="dropdown-item" href="absensi.php?module=api"> <i class="fa fa-male"></i> <span>Absen</span> </a>
						</li>
						
         	 			<li>
							<a class="dropdown-item" href="absensi.php?module=kinerja"> <i class="fa fa-tty"></i> <span>Izin</span> </a>
						</li>
						<li>
							<a class="dropdown-item" href="absensi.php?module=cuti"> <i class="fa fa-thumb-tack"></i> <span>Cuti</span> </a>
						</li>
						<li>
							<a class="dropdown-item" href="absensi.php?module=marketing_sales"> <i class="fa fa-file-pdf-o"></i> <span>Laporan</span> </a>
						</li>
						<li>
							<a class="dropdown-item" href="absensi.php?module=marketing_sales"> <i class="fa fa-cog"></i> <span>Profil</span> </a>
						</li>
						<li>
