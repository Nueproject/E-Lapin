	...
	<body class="sidebar-mini skin-green-light fixed">
		<div class="wrapper">
			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li>
							<a  class="dropdown-item" href="ngadimin.php?module=home"> <i class="fa fa-home"></i> <span>Home</span> </a>
						</li>
					
						
						<li>
							<a class="dropdown-item" href="ngadimin.php?module=absen_harian"> <i class="fa fa-calendar-o"></i> <span>Data Absensi</span> </a>
						</li>
						<li>
							<a class="dropdown-item" href="ngadimin.php?module=rekap_absensi"> <i class="fa fa-clock-o"></i> <span>Rekap Absensi</span> </a>
						</li>
           				 
						<li>
							<a class="dropdown-item" href="ngadimin.php?module=data_izin"> <i class="fa fa-inbox"></i> <span>Data Izin</span> </a>
						</li>
						<li>
							<a class="dropdown-item" href="ngadimin.php?module=data_cuti"> <i class="fa fa-location-arrow"></i> <span>Data Cuti</span> </a>
						</li>
						<li>
							<a class="dropdown-item" href="ngadimin.php?module=data_laporan"> <i class="fa fa-print"></i> <span>Data Laporan</span> </a>
						</li>
						<li>
            ...
            if ($_GET['module'] == 'home') {
                ...
                include "module/admin/list_user.php";
            } elseif ($_GET['module'] == 'detail_lap') {
                include "module/admin/detail_lap.php";
            } elseif ($_GET['module'] == 'absen_harian') {
                include "module/admin/absen_harian.php";
            } elseif ($_GET['module'] == 'detail_absen') {
                include "module/admin/detail_absen.php";
			} elseif ($_GET['module'] == 'rekap_absensi') {
                include "module/admin/rekap_absensi.php";
			} elseif ($_GET['module'] == 'data_izin') {
                include "module/admin/data_izin.php";
			} elseif ($_GET['module'] == 'data_cuti') {
                include "module/admin/data_cuti.php";
			} elseif ($_GET['module'] == 'data_laporan') {
                include "module/admin/data_laporan.php";
            } elseif ($_GET['module'] == 'hapus_user') {
                include "module/admin/aksi_hapus.php";
			} else {
